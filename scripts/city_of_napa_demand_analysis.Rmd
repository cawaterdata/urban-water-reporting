...
Water losses are not included in demand for the Water Loss Report. Losses are reported Seperatly and the value is below: 
```{r}
...
Water exported in AF are not included in demand for the Water Loss Report. Exports are reported seperatly and the value is below: 
```{r}
...
```{r}
supply_and_demand_data %>% filter(report_name == "CR", year == 2020, 
                                 category == "demand") 
