---
title: "Urban Water Data Reporting | Guided examples & key insights"
output:
...
Table 1 below shows the mapping for water use groups across the UWMP, CR, EAR and WLR. 
...
### Characteristics of stare reporting requirements
The characteristics of state reporting requirements relative to local suppliers can
be described as:
...
The characteristics of local agencies relative to state reporting requirements
can be described as:

- Misalignment in frequency and scale of data collected 
- Misalignment in timing of QA/QC processes
- Different methodologies used to summarize data across agencies
- Different methodologies and data used within an agency across reports