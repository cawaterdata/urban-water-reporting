...
demand_data <- demand_data_raw %>% 
  ...
  group_by(report_name, supplier_name, year, category, use_type) %>%
...
Figure 3 compares water supply and demand by use category (see the data mapping tab for more details on categories)
across reports for Agency 3. Recycled water accounts for some of the differences across reports
because it is not reported for the WLR or CR. Agency 3 reports recycled water use as an Other use on the EAR (Figure 3).
Another reason values may differ across reports is the reporting timeline may differ. The EAR is reported on an annual
