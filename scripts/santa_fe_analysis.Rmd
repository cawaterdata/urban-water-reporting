...
The *difference* in the `r metric` between the `r report_1` and `r report_3` is: `r delta_water_supplied` Acre Feet. 
...
The *difference* in the `r metric` between the `r report_1` and `r report_4` is: `r delta_water_supplied` Acre Feet. 
...
The *difference* in the `r metric` between the `r report_2` and `r report_3` is: `r delta_water_supplied` Acre Feet. 
...
The *difference* in the `r metric` between the `r report_2` and `r report_4` is: `r delta_water_supplied` Acre Feet. 
...
The *difference* in the `r metric` between the `r report_3` and `r report_4` is: `r delta_water_supplied` Acre Feet. 
