...
supply_and_demand_data <- read_rds("data/supply_and_demand_data.rds") %>%
  filter(supplier_name  %in% c("Santa Fe Irrigation District", "SANTA FE I.D.")) %>% glimpse
...
supply_by_report
write_rds(supply_by_report, "data/santa_fe_supply_af_volumes.rds")
```
...
write_rds(all_reports_supply, "data/santa_fe_s_with_subcategories.rds")
```
